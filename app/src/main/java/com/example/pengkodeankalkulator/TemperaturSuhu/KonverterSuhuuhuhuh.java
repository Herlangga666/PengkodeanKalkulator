package com.example.pengkodeankalkulator.TemperaturSuhu;
...
public class KonverterSuhuuhuhuh extends AppCompatActivity {
    EditText celcius,kelvin,farenheit,reamur;
    Button btn_konversi;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_konverter_suhuuhuhuh);
